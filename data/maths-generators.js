...
export const MATHS_GENERATORS = [
  { id: "m1gen-percent", topicId: "maths-1", grade: "FF", hint: "Try finding 10% of the number first, then use that to build up to the percentage you need.", generate: percentOfGenerator },
  { id: "m1gen-round", topicId: "maths-1", grade: "GG", hint: "Look only at the digit just after the second decimal place to decide whether to round up.", generate: roundingGenerator },
  { id: "m1gen-standardform", topicId: "maths-1", grade: "FF", hint: "Multiplying by a power of 10 just shifts the decimal point that many places to the right.", generate: standardFormGenerator },
  { id: "m2gen-linear", topicId: "maths-2", grade: "EE", hint: "Get the x-term on its own first by dealing with the number that's added or subtracted, then divide.", generate: solveLinearGenerator },
  { id: "m2gen-nthterm", topicId: "maths-2", grade: "GG", hint: "Substitute the term number into the expression in place of n.", generate: nthTermGenerator },
  { id: "m2gen-expand", topicId: "maths-2", grade: "EE", hint: "Multiply out the bracket first, then combine it with the other term.", generate: expandSimplifyGenerator },
  { id: "m3gen-shareratio", topicId: "maths-3", grade: "EE", hint: "Work out what one share is worth first, then scale up to the share you need.", generate: shareRatioGenerator },
  { id: "m3gen-percentchange", topicId: "maths-3", grade: "FF", hint: "Work out the percentage of the original amount first, then add or subtract it.", generate: percentChangeGenerator },
  { id: "m3gen-speed", topicId: "maths-3", grade: "GG", hint: "Speed is distance divided by time.", generate: speedGenerator },
  { id: "m4gen-rectarea", topicId: "maths-4", grade: "GG", hint: "Multiply the two side lengths together.", generate: rectangleAreaGenerator },
  { id: "m4gen-cuboidvol", topicId: "maths-4", grade: "GG", hint: "Multiply all three dimensions together.", generate: cuboidVolumeGenerator },
  { id: "m4gen-pythagoras", topicId: "maths-4", grade: "EE", hint: "This is a right-angled triangle — think about the relationship between the squares of its three sides.", generate: pythagorasGenerator },
  { id: "m5gen-mean", topicId: "maths-5", grade: "GG", hint: "Add all the numbers together, then divide by how many there are.", generate: meanGenerator },
  { id: "m5gen-range", topicId: "maths-5", grade: "GG", hint: "Subtract the smallest number from the largest.", generate: rangeGenerator },
  { id: "m5gen-probability", topicId: "maths-5", grade: "FF", hint: "Count how many balls match what you want out of the total, then simplify that fraction.", generate: probabilityGenerator },
];
